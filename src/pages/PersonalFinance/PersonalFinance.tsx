...
const PersonalFinance: FunctionComponent = () => {
  ...
  const table: ReactElement = (
    <TableContainer className="paper">
      ...
      <Button id="addDebtButton" variant="contained" onClick={toggleAddDebtForm} color="primary">
  ...
  return (
    <div className="container">
      ...
      <div className="totalDebtContainer">
        ...
        <p className="debt">${debtTotal.toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
      </div>
